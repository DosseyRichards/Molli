...
exports.getRecentMontagePaginate = function(req, res, next) {
	montage.paginate({}, {page:req.params.current_page , limit:20},{sort:{created_on:-1}}, function(err, docs){
...
exports.getPopularMontagePaginate = function(req, res, next) {
	montage.paginate({}, {page:req.params.current_page , limit:20},{sort:{views:-1, created_on:-1}}, function(err, docs){
		res.json(results:[docs]);
	});		
};
